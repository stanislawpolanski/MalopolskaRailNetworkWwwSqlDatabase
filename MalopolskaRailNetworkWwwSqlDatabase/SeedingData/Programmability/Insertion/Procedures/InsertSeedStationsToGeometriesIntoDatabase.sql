CREATE PROCEDURE [DataSeedInsertionSchema].[InsertSeedStationsToGeometriesIntoDatabase]
    @SeedTable DataSeedInsertionSchema.StationsToGeometriesInsertionType readonly
AS
